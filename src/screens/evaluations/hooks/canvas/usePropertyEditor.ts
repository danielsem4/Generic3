...
import type { IQComponent, IQOptionItem } from "@/common/types/evaluation";
import { DYNAMIC_ANSWER_KEYS, isOptionBasedComponent } from "@/common/types/evaluation";
...
export function usePropertyEditor() {
  ...
  const updateComponentProps = useEvaluationBuilderStore(
