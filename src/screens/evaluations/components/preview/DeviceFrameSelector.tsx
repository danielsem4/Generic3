...
const devices: { key: DeviceSize; icon: React.ElementType; labelKey: string }[] = [
  { key: "mobile", icon: Smartphone, labelKey: "evaluations.device.mobile" },
  { key: "tablet", icon: Tablet, labelKey: "evaluations.device.tablet" },
  { key: "desktop", icon: Monitor, labelKey: "evaluations.device.desktop" },
];
