...
import type { IQScreen, DeviceSize } from "@/common/types/evaluation";
      ...
      <div className="flex items-center justify-between border-b bg-card px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          {screens.length > 1 && (
            <span className="text-sm text-muted-foreground">
              {t("evaluations.builder.preview.screenOf", {
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="outline" size="sm" onClick={onExit} className="gap-1">
            <X size={14} />
            {t("evaluations.builder.exitPreview")}
          </Button>
        </div>
      </div>
        ...
        <DeviceFrame width={deviceWidth} height={deviceHeight}>
          ...
          {screens.length > 1 && (
            <div className="flex items-center justify-between border-t px-4 py-3">
              ...
              >
                <ChevronLeft size={14} />
                {t("evaluations.builder.preview.previous")}
              </Button>
              <Button
                variant="outline"
                size="sm"
                ...
                className="gap-1"
              >
                {t("evaluations.builder.preview.next")}
