        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div className="bg-card p-6 rounded-2xl border border-border shadow-sm">
              ...
              <h3 className="text-3xl font-black mt-2 text-foreground">{summary?.number_of_measurements || 0}</h3>
            </div>
          </div>

          <div className="grid gap-8">
            <AnalyticsChartCard title={t("analytics.measurements.usageChart")} data={usage} />
            <AnalyticsChartCard title={t("analytics.measurements.busiestDaysChart")} data={fillMissingDays(busiestDays)} />
          </div>
        </>
      )}
    </div>
