...
{isLoading ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div className="bg-card p-6 rounded-2xl border border-border shadow-sm">
              <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Active Activities</p>
              <h3 className="text-3xl font-black mt-2 text-foreground">{summary?.number_of_activities || 0}</h3>
            </div>
          </div>
