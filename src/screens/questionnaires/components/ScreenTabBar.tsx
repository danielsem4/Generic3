...
import type { IQScreen } from "@/common/types/questionnaire";
  ...
  return (
    <div className="flex items-center gap-1 border-b bg-card px-2 py-1 overflow-x-auto shrink-0">
        ...
        >
          ...
          {canDeleteScreen && index !== activeScreenIndex && (
            <button
              ...
              title={t("questionnaires.builder.screens.deleteScreen")}
            >
              <X size={12} />
            </button>
          )}
      ...
      <Button
        ...
        title={t("questionnaires.builder.screens.addScreen")}
      >
        <Plus size={14} />
      </Button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-card rounded-lg p-4 shadow-lg max-w-sm mx-4">
            <p className="text-sm font-medium mb-3">
              {t("questionnaires.builder.screens.deleteConfirm")}
            </p>
            <div className="flex justify-end gap-2">
              ...
              >
                {t("questionnaires.builder.screens.deleteScreen")}
              </Button>
            </div>
          </div>
        </div>
