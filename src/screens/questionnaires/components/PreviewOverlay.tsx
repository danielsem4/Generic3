...
import type { IQScreen, DeviceSize } from "@/common/types/questionnaire";
      ...
      <div className="flex items-center justify-between border-b bg-card px-4 py-3">
        <div className="flex items-center gap-3">
          <h1 className="text-lg font-semibold">
            {t("questionnaires.builder.previewMode")}
          </h1>
          {screens.length > 1 && (
            <span className="text-sm text-muted-foreground">
              {t("questionnaires.builder.preview.screenOf", {
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="outline" size="sm" onClick={onExit} className="gap-1">
            <X size={14} />
            {t("questionnaires.builder.exitPreview")}
          </Button>
        </div>
      </div>
        ...
        <DeviceFrame width={deviceWidth}>
          ...
          {screens.length > 1 && (
            <div className="flex items-center justify-between border-t px-4 py-3">
              ...
              >
                <ChevronLeft size={14} />
                {t("questionnaires.builder.preview.previous")}
              </Button>
              <Button
                variant="outline"
                size="sm"
                ...
                className="gap-1"
              >
                {t("questionnaires.builder.preview.next")}
