...
import type { IQComponentVersion } from "@/common/types/measurement";
  ...
  return (
    <div className="space-y-3">
      ...
      <h4 className="text-xs font-semibold uppercase text-muted-foreground tracking-wide">
        {t("measurements.builder.versionControl")}
      </h4>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-1.5">
              ...
              {versions.map((v) => (
                <option key={v.id} value={v.id}>
                  ...
                  {v.id === activeVersionId
                    ? ` (${t("measurements.builder.activeVersion")})`
                    : ""}
                </option>
              ))}
            </select>
            <Button
              ...
              title={t("measurements.builder.deleteVersion")}
            >
          ...
          >
            <GitBranch size={14} />
            {t("measurements.builder.branchVersion")}
          </Button>
        </div>
      ) : (
        <div className="space-y-2">
          <p className="text-xs text-muted-foreground">
            {t("measurements.builder.noVersions")}
          </p>
          <Button
            variant="outline"
            size="sm"
