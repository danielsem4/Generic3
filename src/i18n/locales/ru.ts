const ru = {
  ...
  forgotPassword: {
    ...
    errorCodeInvalid: "Неверный или просроченный код. Попробуйте снова.",
    errorCodeNotVerified: "Пожалуйста, подтвердите код перед установкой нового пароля.",
    codeTitle: "Введите код подтверждения",
    codeDesc: "Введите 6-значный код, который мы отправили на ваш email.",
  ...
  patientEvaluations: {
    ...
    deleteConfirm: {
      ...
      description: "Это действие навсегда удалит измерение из записи пациента.",
      cancel: "Отмена",
      confirm: "Удалить"
    },
    deleteSuccess: "Измерение успешно удалено.",
    deleteError: "Не удалось удалить измерение. Попробуйте снова.",
  },
  ...
  common: {
    ...
    loading: {
      ...
      fetchData: "Пожалуйста, подождите, пока мы собираем данные.",
  ...
  graphs: {
    title: "Графики",
    createNew: "Создать",
    createTitle: "Создание графика",
    editTitle: "Редактирование графика",
    createSubtitle: "Укажите, какие данные отображать и как сопоставить оси.",
    editSubtitle: "Обновите сведения о графике и настройки осей.",
    basicInfoSection: "Основная информация",
    axisSection: "Настройка осей",
    patientTitle: "Графики пациента",
    availableCharts: "Доступные графики",
    dateFilter: "Дата",
    aboutChart: "Об этом графике",
    valueLegend: "Что означают значения",
    seriesToggle: "Отображаемые ряды",
    seriesUnnamed: "Без названия",
    searchPlaceholder: "Поиск графиков...",
    empty: "Графики ещё не настроены.",
    nameLabel: "Название",
    namePlaceholder: "Введите название графика...",
    questionnaireLabel: "Опросник",
    ...
    xAxisLabel: "Ось X",
    yAxisLabel: "Ось Y",
    axisLabelLabel: "Подпись оси",
    axisLabelPlaceholder: "напр. Дата, Балл...",
    axisSource: {
      submissionDate: "Дата отправки",
      submissionScore: "Балл отправки",
      elementAnswer: "Ответ на вопрос",
    },
    selectElement: "Выберите вопрос...",
    save: "Сохранить",
    edit: "Редактировать",
    delete: "Удалить",
    cancel: "Отмена",
    deleteTitle: "Удаление графика",
    deleteDescription: "Вы уверены, что хотите удалить \"{{name}}\"? Это действие нельзя отменить.",
    loading: "Загрузка графика...",
    noData: "Для этого пациента пока нет данных.",
    createSuccess: "График успешно создан",
    createError: "Не удалось создать график",
    updateSuccess: "График успешно обновлён",
    updateError: "Не удалось обновить график",
    deleteSuccess: "График успешно удалён",
    deleteError: "Не удалось удалить график",
    errName: "Название должно содержать не менее 2 символов",
    errEvaluation: "Пожалуйста, выберите опросник",
    errChartType: "Пожалуйста, выберите тип графика",
    errElement: "Пожалуйста, выберите вопрос",
    errOverlayQuestion: "Пожалуйста, выберите опросник и вопрос для этого источника данных",
    overlay: {
      section: "Дополнительные данные",
      hint: "Добавьте данные из других вопросов или модулей для отображения на том же графике.",
      add: "Добавить источник данных",
      remove: "Удалить",
      typeQuestion: "Другой вопрос",
      typeMedication: "Принятые лекарства",
      typeActivity: "Выполненная активность",
      renderMarkers: "Показать как цветные маркеры",
      renderLine: "Показать как линию",
      namePlaceholder: "Фильтр по имени (оставьте пустым для всех)...",
      labelPlaceholder: "Отображаемая метка (необязательно)...",
      colorLabel: "Цвет",
    },
  },
...
analytics: {
  title: "Аналитика",
  subtitle: "Нажмите на карточку, чтобы просмотреть подробную статистику и графики.",
  loading: "Загрузка аналитики...",
  error: "Не удалось загрузить аналитику. Пожалуйста, попробуйте снова.",
  cards: {
    activities: {
      title: "Аналитика активности",
      description: "Анализ использования активностей, тенденций и данных о вовлеченности пациентов."
    },
    medications: {
  ...
  summary: {
    total: "Всего подано",
    mostUsed: "Самый используемый опрос",
...
filters: {
  ...
  evaluations: {
    ...
    noData: "Пока нет измерений. Создайте первое!",
    ...
    createError: "Не удалось создать измерение. Попробуйте снова.",
    deleteSuccess: "Измерение успешно удалено",
    deleteError: "Не удалось удалить измерение. Попробуйте снова.",
    updateSuccess: "Измерение успешно обновлено",
    updateError: "Не удалось обновить измерение. Попробуйте снова.",
    editTitle: "Редактировать измерение",
    isPublic: "Публичное",
    addExisting: "Добавить существующее",
    addExistingTitle: "Добавить существующее измерение",
    noExistingData: "Нет доступных измерений.",
    searchExisting: "Поиск существующих измерений...",
    add: "Добавить",
    typeLabel: "Тип",
    errType: "Пожалуйста, выберите тип измерения",
    public: "Публичное",
    active: "Активное",
    adoptSuccess: "Измерение успешно добавлено",
    adoptError: "Не удалось добавить измерение. Попробуйте снова.",
    ...
    score: "Баллы",
    error_title: "Ошибка: результат не найден",
    error_desc: "Проверьте корректность идентификаторов.",
    ...
    analytics: {
      ...
      pass_fail_ratio: "Соотношение пройдено/не пройдено",
      passed_label: "Процент прохождения",
      pass: "Зачёт",
      fail: "Не зачёт",
      count: "Количество",
    },
    ...
    builder: {
      ...
      saveError: "Не удалось сохранить структуру. Попробуйте снова.",
      back: "Назад",
      emptyCanvas: "Перетащите компоненты слева, чтобы начать",
      noSelection: "Выберите компонент для редактирования его свойств",
      properties: "Свойства",
      screens: {
    ...
    components: {
      ...
      radioGroup: "Один выбор",
      cardRadioGroup: "Карточка выбора",
      cardMultiSelect: "Карточка множественного выбора",
      datePicker: "Дата",
      timePicker: "Время",
      scale: "Шкала",
  ...
  parkinsonSensors: {
    title: "Датчики Паркинсона",
    description:
      "Сбор и анализ данных носимых датчиков движения для оценки двигательных симптомов болезни Паркинсона. Мобильное приложение непрерывно считывает данные акселерометра, гироскопа и шагомера, чтобы выявлять тремор, падения, почти-падения и состояния действия лекарства (ВКЛ/ВЫКЛ), а затем загружает результаты для клинического анализа. Выберите пациента, чтобы просмотреть данные его датчиков.",
    viewPatients: "Просмотр пациентов",
    calc: {
      heading: "Как выполняются расчёты",
      intro:
        "Состояние лекарства (ВКЛ/ВЫКЛ) оценивается путём сравнения текущей активности пациента с его персональным базовым уровнем, который постепенно формируется на устройстве.",
      metricsTitle: "1. Расчёт метрик активности",
      metricsBody:
        "За окно не менее 60 выборок вычисляются средняя величина ускорения, изменчивость ускорения (стандартное отклонение), средняя величина гироскопа и частота шагов (изменение числа шагов в минуту).",
      baselineTitle: "2. Расчёт базового уровня",
      baselineBody:
        "Эти метрики усредняются со временем вместе со стандартными отклонениями в персональный базовый уровень, который хранится в локальной базе данных Room. Калибровка считается «завершённой» только после не менее 30 выборок, охватывающих не менее 4 часов (один цикл приёма лекарства).",
      classifyTitle: "3. Классификация состояния ВКЛ/ВЫКЛ",
      classifyBody:
        "Классификатор преобразует текущие метрики в единый взвешенный балл относительно базового уровня и сопоставляет его с состоянием ВКЛ, ВЫКЛ или НЕ ОПРЕДЕЛЕНО.",
      classifyPoints: [
        "Z-оценка по каждому измерению: (текущее значение − среднее базового уровня) / стандартное отклонение базового уровня. Положительное значение означает большую активность, чем обычно.",
        "Взвешенный составной балл: величина ускорения 0,3, частота шагов 0,3, изменчивость ускорения 0,2, активность гироскопа 0,2.",
        "Полоса гистерезиса (от −0,2 до +0,2): состояние меняется только когда балл выходит за полосу, иначе сохраняется предыдущее состояние во избежание мерцания. Балл > 0,2 → ВКЛ, < −0,2 → ВЫКЛ.",
        "Достоверность = min(|балл| ÷ 2, 1).",
        "Возвращает «НЕ ОПРЕДЕЛЕНО» до завершения калибровки.",
      ],
    },
    detectors: {
      heading: "Обнаруживаемые события",
      colEvent: "Событие",
      colSensors: "Основные датчики",
      colMethod: "Основной метод",
      tremor: {
        name: "Тремор",
        sensors: "Линейное ускорение + гироскоп + шаги + свет",
        method:
          "Отношение мощностей FFT в полосе 4–6,5 Гц, совпадение частоты гироскопа, с порогом длительности 8 с.",
      },
      fall: {
        name: "Падение",
        sensors: "Сырое ускорение + линейное ускорение + гироскоп",
        method:
          "Свободное падение (< 3 м/с²) → удар (> 15 м/с²) → 2,5 с неподвижности (низкое среднее и низкое стандартное отклонение).",
      },
      nearFall: {
        name: "Почти-падение",
        sensors: "Линейное ускорение + гироскоп",
        method:
          "Не менее 3 пиков > 14 м/с² плюс гироскоп > 3,5, после чего восстановление до нормы в течение 3 с.",
      },
      onOff: {
        name: "Состояние ВКЛ/ВЫКЛ",
        sensors: "Ускорение + гироскоп + шаги",
        method:
          "Взвешенные z-оценки относительно персонального 4-часового базового уровня с полосой гистерезиса.",
      },
    },
    upload: {
      heading: "Процесс загрузки",
      body:
        "Обнаруженные события (с сырыми буферами акселерометра/гироскопа и агрегированными данными датчиков) преобразуются в серверный запрос, помеченный идентификаторами пациента и клиники, и загружаются через сервис датчиков. У модуля состояния ВКЛ/ВЫКЛ есть собственные DTO, маппер и путь серверного запроса.",
    },
    patientView: {
      empty: "Данные датчиков ещё не загружены.",
      error_title: "Не удалось загрузить данные датчиков",
      error_desc: "При получении данных датчиков произошла ошибка. Попробуйте ещё раз.",
      table: {
        event: "Событие",
