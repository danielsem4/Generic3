  ...
  measurements: {
    ...
    builder: {
      ...
      versions: {
        ...
        variantCount: "{{count}} نسخ",
        noVariant: "لا يوجد متغير — يتم عرض v1 الافتراضي",
        noVariantInPanel: "لا يوجد متغير لهذا العنصر. أنشئ نسخة جديدة.",
        addVariant: "إضافة متغير لهذه النسخة",
        editVariantBtn: "تعديل المتغير",
        addVersion: "إضافة نسخة",
        addVersionTitle: "إضافة متغير للسؤال",
        newKeyPlaceholder: "مفتاح النسخة الجديدة…",
        invalidKey: "يجب أن يكون مفتاح النسخة 1–50 حرفاً: أحرف، أرقام، شرطة أو شرطة سفلية",
        editVariant: "متغير: {{version}}",
        variantLabel: "التسمية",
        answerType: "نوع الإجابة",
        options: "الخيارات",
        allowPartial: "السماح بالنقاط الجزئية",
        variantCreated: "تم إنشاء المتغير",
        variantUpdated: "تم تحديث المتغير",
        variantDeleted: "تم حذف المتغير",
        variantSaveError: "فشل حفظ المتغير",
        variantDeleteError: "فشل حذف المتغير",
        branchNew: "إنشاء نسخة جديدة",
        branchError: "فشل إنشاء نسخة جديدة",
        published: "منشور",
        draft: "مسودة",
        publishedBanner: "هذه النسخة منشورة. لإجراء تغييرات، أنشئ نسخة جديدة.",
