...
modules: {
 ...
 // Patient Details
  ...
  measurements: {
    ...
    createSuccess: "Measurement created successfully",
    createError: "Failed to create measurement. Please try again.",
    deleteSuccess: "Measurement deleted successfully",
    deleteError: "Failed to delete measurement. Please try again.",
    updateSuccess: "Measurement updated successfully",
    updateError: "Failed to update measurement. Please try again.",
    editTitle: "Edit Measurement",
    isPublic: "Is Public",
    addExisting: "Add Existing",
    addExistingTitle: "Add Existing Measurement",
    noExistingData: "No existing measurements available.",
    searchExisting: "Search existing measurements...",
    add: "Add",
    typeLabel: "Type",
    errType: "Please select a measurement type",
    public: "Public",
    active: "Active",
    adoptSuccess: "Measurement adopted successfully",
    adoptError: "Failed to adopt measurement. Please try again.",
    ...
    builder: {
      ...
      versions: {
        ...
        variantCount: "{{count}} versions",
        noVariant: "No variant — showing v1 default",
        noVariantInPanel: "No variant exists for this version. Branch a new version to create one.",
        addVariant: "Add variant for this version",
        editVariantBtn: "Edit variant",
        addVersion: "Add version",
        addVersionTitle: "Add variant for a version",
        newKeyPlaceholder: "New version key…",
        invalidKey: "Version key must be 1–50 alphanumeric, hyphens or underscores",
        editVariant: "Variant: {{version}}",
        variantLabel: "Label",
        answerType: "Answer Type",
        options: "Options",
        allowPartial: "Allow partial score",
        variantCreated: "Variant created",
        variantUpdated: "Variant updated",
        variantDeleted: "Variant deleted",
        variantSaveError: "Failed to save variant",
        variantDeleteError: "Failed to delete variant",
        branchNew: "Branch New Version",
        branchError: "Failed to branch new version",
        published: "Published",
        draft: "Draft",
        publishedBanner: "This version is published. To make changes, branch a new version.",
