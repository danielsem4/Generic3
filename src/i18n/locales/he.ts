  ...
  measurements: {
    ...
    builder: {
      ...
      versions: {
        label: "גרסה",
        version: "גרסה",
        versionControl: "בקרת גרסאות",
        variantCount: "{{count}} גרסאות",
        noVariant: "אין גרסה — מוצגת ברירת המחדל v1",
        noVariantInPanel: "אין גרסה לפריט זה. צור גרסה חדשה.",
        addVariant: "הוסף גרסה לגרסה זו",
        editVariantBtn: "עריכת גרסה",
        addVersion: "הוסף גרסה",
        addVersionTitle: "הוסף גרסה לשאלה",
        newKeyPlaceholder: "מפתח גרסה חדשה…",
        invalidKey: "מפתח גרסה חייב להיות 1–50 תווים: אותיות, מספרים, מקף או קו תחתי",
        editVariant: "גרסה: {{version}}",
        variantLabel: "כותרת",
        answerType: "סוג תשובה",
        options: "אפשרויות",
        allowPartial: "ציון חלקי",
        variantCreated: "גרסה נוצרה",
        variantUpdated: "גרסה עודכנה",
        variantDeleted: "גרסה נמחקה",
        variantSaveError: "שגיאה בשמירת הגרסה",
        variantDeleteError: "שגיאה במחיקת הגרסה",
        branchNew: "צור גרסה חדשה",
        branchError: "שגיאה ביצירת גרסה חדשה",
        published: "פורסם",
        draft: "טיוטה",
        publishedBanner: "גרסה זו פורסמה. כדי לערוך, צור גרסה חדשה.",
